...
```{r}
gf$review_datetime_utc = format(as.Date(gf$review_datetime_utc, format="%m/%d/%Y"), format="%Y-%m")
```
```{r}
library(car)
coul <- brewer.pal(9, "YlGnBu")
barplot(table(gf$review_datetime_utc), col=coul, main="Review Date", las=2)
```
